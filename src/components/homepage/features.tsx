...
const FeatureListItem = ({
  ...
  <Card className={cn("h-full w-full rounded-none p-2 lg:p-5", className)}>
    <CardHeader>
      <CardTitle className="text-left text-2xl font-semibold leading-none tracking-tight lg:text-center">
        {title}
      </CardTitle>
    </CardHeader>
    <CardContent>
